...
inline fun contractInfo(block: jmes.wasm.v1beta1.ContractInfoKt.Dsl.() -> Unit): jmes.wasm.v1beta1.Wasm.ContractInfo =
  jmes.wasm.v1beta1.ContractInfoKt.Dsl._create(jmes.wasm.v1beta1.Wasm.ContractInfo.newBuilder()).apply { block() }._build()
object ContractInfoKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.wasm.v1beta1.Wasm.ContractInfo.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.wasm.v1beta1.Wasm.ContractInfo.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.wasm.v1beta1.Wasm.ContractInfo = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.wasm.v1beta1.Wasm.ContractInfo.copy(block: jmes.wasm.v1beta1.ContractInfoKt.Dsl.() -> Unit): jmes.wasm.v1beta1.Wasm.ContractInfo =
  jmes.wasm.v1beta1.ContractInfoKt.Dsl._create(this.toBuilder()).apply { block() }._build()
