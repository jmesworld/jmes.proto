...
inline fun msgExecuteContract(block: jmes.wasm.v1beta1.MsgExecuteContractKt.Dsl.() -> Unit): jmes.wasm.v1beta1.Tx.MsgExecuteContract =
  jmes.wasm.v1beta1.MsgExecuteContractKt.Dsl._create(jmes.wasm.v1beta1.Tx.MsgExecuteContract.newBuilder()).apply { block() }._build()
object MsgExecuteContractKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.wasm.v1beta1.Tx.MsgExecuteContract.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.wasm.v1beta1.Tx.MsgExecuteContract.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.wasm.v1beta1.Tx.MsgExecuteContract = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.wasm.v1beta1.Tx.MsgExecuteContract.copy(block: jmes.wasm.v1beta1.MsgExecuteContractKt.Dsl.() -> Unit): jmes.wasm.v1beta1.Tx.MsgExecuteContract =
  jmes.wasm.v1beta1.MsgExecuteContractKt.Dsl._create(this.toBuilder()).apply { block() }._build()
