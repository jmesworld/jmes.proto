...
inline fun msgSwapSend(block: jmes.market.v1beta1.MsgSwapSendKt.Dsl.() -> Unit): jmes.market.v1beta1.Tx.MsgSwapSend =
  jmes.market.v1beta1.MsgSwapSendKt.Dsl._create(jmes.market.v1beta1.Tx.MsgSwapSend.newBuilder()).apply { block() }._build()
object MsgSwapSendKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.market.v1beta1.Tx.MsgSwapSend.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.market.v1beta1.Tx.MsgSwapSend.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.market.v1beta1.Tx.MsgSwapSend = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.market.v1beta1.Tx.MsgSwapSend.copy(block: jmes.market.v1beta1.MsgSwapSendKt.Dsl.() -> Unit): jmes.market.v1beta1.Tx.MsgSwapSend =
  jmes.market.v1beta1.MsgSwapSendKt.Dsl._create(this.toBuilder()).apply { block() }._build()
