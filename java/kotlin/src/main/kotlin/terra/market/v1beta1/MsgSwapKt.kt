...
inline fun msgSwap(block: jmes.market.v1beta1.MsgSwapKt.Dsl.() -> Unit): jmes.market.v1beta1.Tx.MsgSwap =
  jmes.market.v1beta1.MsgSwapKt.Dsl._create(jmes.market.v1beta1.Tx.MsgSwap.newBuilder()).apply { block() }._build()
object MsgSwapKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.market.v1beta1.Tx.MsgSwap.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.market.v1beta1.Tx.MsgSwap.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.market.v1beta1.Tx.MsgSwap = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.market.v1beta1.Tx.MsgSwap.copy(block: jmes.market.v1beta1.MsgSwapKt.Dsl.() -> Unit): jmes.market.v1beta1.Tx.MsgSwap =
  jmes.market.v1beta1.MsgSwapKt.Dsl._create(this.toBuilder()).apply { block() }._build()
