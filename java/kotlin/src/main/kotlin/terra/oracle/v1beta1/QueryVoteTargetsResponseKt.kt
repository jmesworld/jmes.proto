...
inline fun queryVoteTargetsResponse(block: jmes.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl.() -> Unit): jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse =
  jmes.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl._create(jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.newBuilder()).apply { block() }._build()
object QueryVoteTargetsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.copy(block: jmes.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl.() -> Unit): jmes.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse =
  jmes.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
