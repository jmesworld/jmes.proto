...
inline fun queryExchangeRatesResponse(block: jmes.oracle.v1beta1.QueryExchangeRatesResponseKt.Dsl.() -> Unit): jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse =
  jmes.oracle.v1beta1.QueryExchangeRatesResponseKt.Dsl._create(jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse.newBuilder()).apply { block() }._build()
object QueryExchangeRatesResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse.copy(block: jmes.oracle.v1beta1.QueryExchangeRatesResponseKt.Dsl.() -> Unit): jmes.oracle.v1beta1.QueryOuterClass.QueryExchangeRatesResponse =
  jmes.oracle.v1beta1.QueryExchangeRatesResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
