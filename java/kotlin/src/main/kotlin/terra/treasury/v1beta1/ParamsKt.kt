...
inline fun params(block: jmes.treasury.v1beta1.ParamsKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.Params =
  jmes.treasury.v1beta1.ParamsKt.Dsl._create(jmes.treasury.v1beta1.Treasury.Params.newBuilder()).apply { block() }._build()
object ParamsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.treasury.v1beta1.Treasury.Params.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.treasury.v1beta1.Treasury.Params.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.treasury.v1beta1.Treasury.Params = _builder.build()
     ...
     */
    var taxPolicy: jmes.treasury.v1beta1.Treasury.PolicyConstraints
     ...
     */
    var rewardPolicy: jmes.treasury.v1beta1.Treasury.PolicyConstraints
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.treasury.v1beta1.Treasury.Params.copy(block: jmes.treasury.v1beta1.ParamsKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.Params =
  jmes.treasury.v1beta1.ParamsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
