...
inline fun epochInitialIssuance(block: jmes.treasury.v1beta1.EpochInitialIssuanceKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.EpochInitialIssuance =
  jmes.treasury.v1beta1.EpochInitialIssuanceKt.Dsl._create(jmes.treasury.v1beta1.Treasury.EpochInitialIssuance.newBuilder()).apply { block() }._build()
object EpochInitialIssuanceKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.treasury.v1beta1.Treasury.EpochInitialIssuance.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.treasury.v1beta1.Treasury.EpochInitialIssuance.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.treasury.v1beta1.Treasury.EpochInitialIssuance = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.treasury.v1beta1.Treasury.EpochInitialIssuance.copy(block: jmes.treasury.v1beta1.EpochInitialIssuanceKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.EpochInitialIssuance =
  jmes.treasury.v1beta1.EpochInitialIssuanceKt.Dsl._create(this.toBuilder()).apply { block() }._build()
