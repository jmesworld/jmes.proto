...
inline fun epochTaxProceeds(block: jmes.treasury.v1beta1.EpochTaxProceedsKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.EpochTaxProceeds =
  jmes.treasury.v1beta1.EpochTaxProceedsKt.Dsl._create(jmes.treasury.v1beta1.Treasury.EpochTaxProceeds.newBuilder()).apply { block() }._build()
object EpochTaxProceedsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.treasury.v1beta1.Treasury.EpochTaxProceeds.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.treasury.v1beta1.Treasury.EpochTaxProceeds.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.treasury.v1beta1.Treasury.EpochTaxProceeds = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.treasury.v1beta1.Treasury.EpochTaxProceeds.copy(block: jmes.treasury.v1beta1.EpochTaxProceedsKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Treasury.EpochTaxProceeds =
  jmes.treasury.v1beta1.EpochTaxProceedsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
