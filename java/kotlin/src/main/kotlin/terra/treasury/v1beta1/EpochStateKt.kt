...
inline fun epochState(block: jmes.treasury.v1beta1.EpochStateKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Genesis.EpochState =
  jmes.treasury.v1beta1.EpochStateKt.Dsl._create(jmes.treasury.v1beta1.Genesis.EpochState.newBuilder()).apply { block() }._build()
object EpochStateKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: jmes.treasury.v1beta1.Genesis.EpochState.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: jmes.treasury.v1beta1.Genesis.EpochState.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): jmes.treasury.v1beta1.Genesis.EpochState = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun jmes.treasury.v1beta1.Genesis.EpochState.copy(block: jmes.treasury.v1beta1.EpochStateKt.Dsl.() -> Unit): jmes.treasury.v1beta1.Genesis.EpochState =
  jmes.treasury.v1beta1.EpochStateKt.Dsl._create(this.toBuilder()).apply { block() }._build()
